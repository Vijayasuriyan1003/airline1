frappe.query_reports["my_todos"] = {
	...
	formatter(value, row, column, data, default_formatter) {
	  ...
	  if (column.fieldname == "name") {
		  const button_html = `<button class="btn btn-default btn-xs" onclick="frappe.query_reports['my_todos'].close_todo('${value}')">Close</button>`;
		  value = button_html;
	  }
